function [score_dataset, time_dataset] = ysd_mini_func_SPARISH_dataset(src_folder, img_files, flag_dataset, Dic)
...
if strcmp(flag_dataset, 'CIDIQ')
    ...
    parfor ii_img = 1 : num_img
        ...
        % do SPARISH prediction
        tmp_score = SPARISH_index_score(tmp_img_data, Dic);
