...
flag_dataset = 'CLIVE';
[real_CLIVE_score_SVC, real_CLIVE_time_SVC] = ysd_mini_func_SVC_dataset(src_folder, img_files, flag_dataset);
clear src_folder img_files flag_dataset
save('F:\code4graduate\bisaFusion\scoreTIME\real_CLIVE_score_SVC.mat', 'real_CLIVE_score_SVC')
save('F:\code4graduate\bisaFusion\scoreTIME\real_CLIVE_time_SVC.mat', 'real_CLIVE_time_SVC')
...
img_files = dir([src_folder, '*p*']);
flag_dataset = 'KONIQ';
[real_KONIQ_score_SVC, real_KONIQ_time_SVC] = ysd_mini_func_SVC_dataset(src_folder, img_files, flag_dataset);
clear src_folder img_files flag_dataset
save('F:\code4graduate\bisaFusion\scoreTIME\real_KONIQ_score_SVC.mat', 'real_KONIQ_score_SVC')
save('F:\code4graduate\bisaFusion\scoreTIME\real_KONIQ_time_SVC.mat', 'real_KONIQ_time_SVC')
