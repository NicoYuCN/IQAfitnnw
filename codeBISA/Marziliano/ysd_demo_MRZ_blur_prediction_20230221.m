...
% flag_dataset = 'CLIVE';
% [real_CLIVE_score_MRZ, real_CLIVE_time_MRZ] = ysd_mini_func_MRZ_dataset(src_folder, img_files, flag_dataset);
% clear src_folder img_files flag_dataset
% save('F:\code4graduate\bisaFusion\scoreTIME\real_CLIVE_score_MRZ.mat', 'real_CLIVE_score_MRZ')
% save('F:\code4graduate\bisaFusion\scoreTIME\real_CLIVE_time_MRZ.mat', 'real_CLIVE_time_MRZ')
...
img_files = dir([src_folder, '*p*']);
flag_dataset = 'KONIQ';
[real_KONIQ_score_MRZ, real_KONIQ_time_MRZ] = ysd_mini_func_MRZ_dataset(src_folder, img_files, flag_dataset);
clear src_folder img_files flag_dataset
save('F:\code4graduate\bisaFusion\scoreTIME\real_KONIQ_score_MRZ.mat', 'real_KONIQ_score_MRZ')
save('F:\code4graduate\bisaFusion\scoreTIME\real_KONIQ_time_MRZ.mat', 'real_KONIQ_time_MRZ')
