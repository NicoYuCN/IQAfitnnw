function [score_dataset, time_dataset] = ysd_mini_func_SVC_dataset(src_folder, img_files, flag_dataset)

score_dataset = zeros(1, length(img_files));
...
if strcmp(flag_dataset, 'CID2013')
    ...
    num_img = length(img_name_CID2013);
    parfor ii_img = 1 : num_img
        % form the image name
