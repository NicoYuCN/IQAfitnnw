...
flag_dataset = 'CLIVE';
[real_CLIVE_score_MLV, real_CLIVE_time_MLV] = ysd_mini_func_MLV_dataset(src_folder, img_files, flag_dataset);
clear src_folder img_files flag_dataset
save('F:\code4graduate\bisaFusion\scoreTIME\real_CLIVE_score_MLV.mat', 'real_CLIVE_score_MLV')
save('F:\code4graduate\bisaFusion\scoreTIME\real_CLIVE_time_MLV.mat', 'real_CLIVE_time_MLV')
...
img_files = dir([src_folder, '*p*']);
flag_dataset = 'KONIQ';
[real_KONIQ_score_MLV, real_KONIQ_time_MLV] = ysd_mini_func_MLV_dataset(src_folder, img_files, flag_dataset);
clear src_folder img_files flag_dataset
save('F:\code4graduate\bisaFusion\scoreTIME\real_KONIQ_score_MLV.mat', 'real_KONIQ_score_MLV')
save('F:\code4graduate\bisaFusion\scoreTIME\real_KONIQ_time_MLV.mat', 'real_KONIQ_time_MLV')
