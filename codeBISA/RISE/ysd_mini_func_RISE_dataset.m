function [score_dataset, time_dataset] = ysd_mini_func_RISE_dataset(src_folder, img_files, flag_dataset)
...
if strcmp(flag_dataset, 'CIDIQ')
    ...
    for ii_img = 1 : num_img
        ...
        % do RISE prediction
        tmp_score = RISE_index_score(tmp_img_data);
