function [score_dataset, time_dataset] = ysd_mini_func_SyMP_dataset(src_folder, img_files, flag_dataset, MaxPol_kernel)
...
if strcmp(flag_dataset, 'CIDIQ')
    ...
    parfor ii_img = 1 : num_img
        ...
        % do SyMP prediction
        tmp_score = SyMP_index_score(tmp_img_data, MaxPol_kernel);
