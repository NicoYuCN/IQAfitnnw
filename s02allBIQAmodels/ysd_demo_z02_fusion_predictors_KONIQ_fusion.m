...
%
%               Fusion of predictors parfor improved score prediction
%
%--------------------------------------------------------------------------------------
...
%     mdl = fitrsvm( x_train, y_train, 'Standardize', true, 'epsilon', 0.3, 'kernelfunction', 'gaussian', 'KernelScale', 'auto' );
%     %
