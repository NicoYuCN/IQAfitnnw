function [score_dataset, time_dataset] = ysd_mini_func_ARISMC_dataset(src_folder, img_files, flag_dataset)
...
if strcmp(flag_dataset, 'CIDIQ')
    ...
    parfor ii_img = 1 : num_img
        ...
        % do ARISMC prediction
        [tmp_score, ~] = ARISMC_index_score(tmp_img_data);
        % save the prediction score
        score_dataset(1, ii_img) = tmp_score(2);
    end
