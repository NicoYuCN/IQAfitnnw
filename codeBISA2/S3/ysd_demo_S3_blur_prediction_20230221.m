...
flag_dataset = 'CLIVE';
[real_CLIVE_score_S3, real_CLIVE_time_S3] = ysd_mini_func_S3_dataset(src_folder, img_files, flag_dataset);
clear src_folder img_files flag_dataset
save('F:\code4graduate\bisaFusion\scoreTIME\real_CLIVE_score_S3.mat', 'real_CLIVE_score_S3')
save('F:\code4graduate\bisaFusion\scoreTIME\real_CLIVE_time_S3.mat', 'real_CLIVE_time_S3')
...
img_files = dir([src_folder, '*p*']);
flag_dataset = 'KONIQ';
[real_KONIQ_score_S3, real_KONIQ_time_S3] = ysd_mini_func_S3_dataset(src_folder, img_files, flag_dataset);
clear src_folder img_files flag_dataset
save('F:\code4graduate\bisaFusion\scoreTIME\real_KONIQ_score_S3.mat', 'real_KONIQ_score_S3')
save('F:\code4graduate\bisaFusion\scoreTIME\real_KONIQ_time_S3.mat', 'real_KONIQ_time_S3')
