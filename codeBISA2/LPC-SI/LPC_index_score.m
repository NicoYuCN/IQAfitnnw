function [lpc_si, lpc_map] = LPC_index_score(im, scales, w, C, Beta_k, norient, B)
...
if nargin < 7,  B = round(min(row, col)/16); end
if nargin < 6,  norient  = 8; end
if nargin < 5,  Beta_k = 1e-4; end
if nargin < 4,  C = 2; end
if nargin < 3,  w = [1 -3 2]; end
if nargin < 2,  scales   = [1 3/2 2]; end
