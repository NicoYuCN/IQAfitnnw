...
flag_dataset = 'CLIVE';
[real_CLIVE_score_LPC, real_CLIVE_time_LPC] = ysd_mini_func_LPC_dataset(src_folder, img_files, flag_dataset);
clear src_folder img_files flag_dataset
save('F:\code4graduate\bisaFusion\scoreTIME\real_CLIVE_score_LPC.mat', 'real_CLIVE_score_LPC')
save('F:\code4graduate\bisaFusion\scoreTIME\real_CLIVE_time_LPC.mat', 'real_CLIVE_time_LPC')
...
img_files = dir([src_folder, '*p*']);
flag_dataset = 'KONIQ';
[real_KONIQ_score_LPC, real_KONIQ_time_LPC] = ysd_mini_func_LPC_dataset(src_folder, img_files, flag_dataset);
clear src_folder img_files flag_dataset
save('F:\code4graduate\bisaFusion\scoreTIME\real_KONIQ_score_LPC.mat', 'real_KONIQ_score_LPC')
save('F:\code4graduate\bisaFusion\scoreTIME\real_KONIQ_time_LPC.mat', 'real_KONIQ_time_LPC')
