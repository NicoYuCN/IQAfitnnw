...
flag_dataset = 'CLIVE';
[real_CLIVE_score_CPBD, real_CLIVE_time_CPBD] = ysd_mini_func_CPBD_dataset(src_folder, img_files, flag_dataset);
clear src_folder img_files flag_dataset
save('F:\code4graduate\bisaFusion\scoreTIME\real_CLIVE_score_CPBD.mat', 'real_CLIVE_score_CPBD')
save('F:\code4graduate\bisaFusion\scoreTIME\real_CLIVE_time_CPBD.mat', 'real_CLIVE_time_CPBD')
...
img_files = dir([src_folder, '*p*']);
flag_dataset = 'KONIQ';
[real_KONIQ_score_CPBD, real_KONIQ_time_CPBD] = ysd_mini_func_CPBD_dataset(src_folder, img_files, flag_dataset);
clear src_folder img_files flag_dataset
save('F:\code4graduate\bisaFusion\scoreTIME\real_KONIQ_score_CPBD.mat', 'real_KONIQ_score_CPBD')
save('F:\code4graduate\bisaFusion\scoreTIME\real_KONIQ_time_CPBD.mat', 'real_KONIQ_time_CPBD')
%
%